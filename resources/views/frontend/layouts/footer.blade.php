    ...
    <div class="container py-5">
        <div class="row g-5">
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <p class="mb-2"><i
                        class="fa fa-map-marker-alt me-3"></i>{{ $about_us->address ?? 'Dhaka, Bangladesh' }}</p>
                ...
                <div class="d-flex pt-2">
                    @if ($about_us->facebook)
                        <a class="btn btn-outline-light btn-social" href="{{ $about_us->facebook }}"><i
                                class="fab fa-facebook-f"></i></a>
                    @endif
                    @if ($about_us->twitter)
                        <a class="btn btn-outline-light btn-social" href="{{ $about_us->twitter }}"><i
                                class="fab fa-twitter"></i></a>
                    @endif
                    @if ($about_us->youtube)
                        <a class="btn btn-outline-light btn-social" href="{{ $about_us->youtube }}"><i
                                class="fab fa-youtube"></i></a>
                    @endif
                    @if ($about_us->linkedin)
                        <a class="btn btn-outline-light btn-social" href="{{ $about_us->linkedin }}"><i
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="row g-2 pt-2">
                    @foreach (array_slice(json_decode($about_us->gallery, true), 0, 6) as $image)
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="{{ asset('storage/' . $image) }}"
                                alt="Gallery Image" style="width:100%; height: 50px; object-fit: cover;">
        ...
        <div class="copyright">
            <div class="row">
                <div class="col-md-12 text-center mb-3 mb-md-0">
                    © <a class="border-bottom" href="javascript:void(0);">GUB</a> | 
                    <script>
