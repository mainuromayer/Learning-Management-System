                        ...
                        <div class="team-item bg-light">
                            ...
                            <div class="position-relative d-flex justify-content-center" style="margin-top: -23px;">
                                <div class="bg-light d-flex justify-content-center pt-2 px-1">
                                    @if ($instructor->user->facebook)
                                        <a class="btn btn-sm-square btn-primary mx-1" href="{{ $instructor->user->facebook }}"><i class="fab fa-facebook-f"></i></a>
                                    @endif
                                    @if ($instructor->user->twitter)
                                        <a class="btn btn-sm-square btn-primary mx-1" href="{{ $instructor->user->twitter }}"><i class="fab fa-twitter"></i></a>
                                    @endif
                                    @if ($instructor->user->linkedin)
                                        <a class="btn btn-sm-square btn-primary mx-1" href="{{ $instructor->user->linkedin }}"><i class="fab fa-linkedin-in"></i></a>
                                    @endif
                                </div>
                            </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>01877744471</p>
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>neroabahmed78@gmail.com</p>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="javascript:void(0);">LMS</a>, All Right Reserved.
