        ...
        <div class="col-md-12 p-5 pt-3">
            <div class="card card-outline card-primary form-card">
                <div class="card-header">
                    <h3 class="card-title pt-2 pb-2"> Create New Quiz </h3>
                    <div class="card-tools">
                        <a href="{{ route('quiz.list') }}" class="btn btn-sm btn-primary"><i
                                class="bx bx-list-ul pr-2"></i> Quiz List </a>
                    </div>
                </div>
                    ...
                    <div class="input-group row mb-3 {{ $errors->has('hours') || $errors->has('minutes') || $errors->has('seconds') ? 'has-error' : '' }}">
                        ...
                        <div class="col-md-9">
                            <div class="input-group">
                                {!! Form::number('hours', old('hours', floor($duration / 3600)), ['class' => 'form-control mr-2 required', 'placeholder' => 'Hours', 'min' => '0']) !!}
                                {!! $errors->first('hours', '<span class="help-block">:message</span>') !!}

                                {!! Form::number('minutes', old('minutes', floor(($duration % 3600) / 60)), ['class' => 'form-control mr-2 required', 'placeholder' => 'Minutes', 'min' => '0']) !!}
                                {!! $errors->first('minutes', '<span class="help-block">:message</span>') !!}

                                {!! Form::number('seconds', old('seconds', $duration % 60), ['class' => 'form-control mr-2 required', 'placeholder' => 'Seconds', 'min' => '0']) !!}
                        ...
                        <div class="col-md-9">
                            <div class="row">
                                ...
                                {!! Form::label('total_mark', 'Total Mark:', ['class' => 'control-label required-star']) !!}
                                    {!! Form::number('total_mark', old('total_mark'), ['class' => 'form-control required', 'placeholder' => 'Total Mark']) !!}
                                ...
                                {!! Form::label('pass_mark', 'Pass Mark:', ['class' => 'control-label required-star']) !!}
                                    {!! Form::number('pass_mark', old('pass_mark'), ['class' => 'form-control required', 'placeholder' => 'Pass Mark']) !!}
                                    {!! $errors->first('pass_mark', '<span class="help-block">:message</span>') !!}
                                </div>

                                <div class="col-md-4">
                                {!! Form::label('retake', 'Retake:', ['class' => 'control-label required-star']) !!}
                                    {!! Form::number('retake', old('retake'), ['class' => 'form-control required', 'placeholder' => 'Retake']) !!}
